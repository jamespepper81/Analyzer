                ...
                <div className="lg:col-span-1 space-y-4 sm:space-y-6">
                    <Card className="border-2 shadow-md">
                        ...
                        <CardContent className="space-y-1">
                            <DetailItem label={isWalletTx ? "Net Amount" : "Total Transacted"}>
                                <div className="text-right">
                                    <div className="font-bold">
                                        {isWalletTx ? tx.btc.toFixed(8) : (tx.totalValue || tx.btc).toFixed(8)} BTC
                                    </div>
                                    <div className="text-muted-foreground">
                                        {formatCurrency(isWalletTx ? netAmountFiat : (tx.totalValue || tx.btc) * btcPrice)}
                                    </div>
                                </div>
                            </DetailItem>
