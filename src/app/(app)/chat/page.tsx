    ...
    <div className="flex h-[calc(100vh-8rem)] flex-col">
      <div className="flex-1 overflow-y-auto px-2 sm:px-4" ref={scrollAreaRef} aria-live="polite">
        <div className="mx-auto max-w-3xl space-y-4 sm:space-y-6 pt-4">
          ...
          <Alert
            variant="warning"
            className="shadow-md border-orange-500/40 bg-orange-50 text-orange-950 dark:border-orange-400/40 dark:bg-orange-500/15 dark:text-orange-100"
          >
            <AlertTriangle className="h-5 w-5 text-orange-600 dark:text-orange-400" />
            <AlertTitle className="text-orange-950 dark:text-orange-100">Update - AI Chat Response Time</AlertTitle>
